...
class OneToOneMatchingV3ViewModel : AbstractResourceViewModel(), IOneToOneMatchingV3ViewModel, IInterestsCallback {
    ...
    private val interestSearchInterval = 20L
    ...
    override fun shouldShowTotalChatsRemaining(): Observable<Boolean> = Observable.just(false)
    ...
    private fun getCurrentUserVariant(): String {
        ...
        return when {
            abManager.isIn(AbManager.ANONYMOUS_MATCHING_V3, AbManager.ANONYMOUS_MATCHING_V3_SHOW_LAUNCHSCREEN_INTEREST_0) -> AbManager.ANONYMOUS_MATCHING_V3_SHOW_LAUNCHSCREEN_INTEREST_0
            abManager.isIn(AbManager.ANONYMOUS_MATCHING_V3, AbManager.ANONYMOUS_MATCHING_V3_SHOW_LAUNCHSCREEN_INTEREST_2) -> AbManager.ANONYMOUS_MATCHING_V3_SHOW_LAUNCHSCREEN_INTEREST_2
            abManager.isIn(AbManager.ANONYMOUS_MATCHING_V3, AbManager.ANONYMOUS_MATCHING_V3_SHOW_LAUNCHSCREEN_INTEREST_5) -> AbManager.ANONYMOUS_MATCHING_V3_SHOW_LAUNCHSCREEN_INTEREST_5
            else -> AbManager.ANONYMOUS_MATCHING_V3_SHOW_QUICKCHAT_INTEREST
        }
    }
}
